...
from agents import ConservativeBot, AggressiveBot, MathBot, NeuralBot
...
class SelfPlayCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        if self.n_calls % self.check_freq == 0:
            ...
            gen_name = f"model_gen_{self.generation}"
            ...
            # Export weights
            export_to_json(self.model, "best_weights.json", "trainedModel.ts")
            ...
            for _ in range(3):
                ...
                if choice < 0.5 and self.history:
                    ...
                    # Heuristics
                    new_opponents.append(random.choice([ConservativeBot(), AggressiveBot(), MathBot()]))
...
def train():
    ...
    bootcamp_opponents = [ConservativeBot(), AggressiveBot(), MathBot()]
    ...
    model.save("rl_trainer/checkpoints/phase1_model")
    ...
    model.save("rl_trainer/checkpoints/final_model")
    export_to_json(model, "best_weights.json", "trainedModel.ts")
